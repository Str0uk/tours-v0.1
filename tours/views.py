...
class MainView(TemplateView):
    def get(self, request, *args, **kwargs):
        return render(request, 'index.html', {'title': title, 'subtitle': subtitle, 'description': description,
                                              'departures': departures, 'tours': tours[:9]})


class DepartureView(TemplateView):
    def get(self, request, *args, **kwargs):
        return render(request, 'departure/departure.html', {'title': title, 'subtitle': subtitle, 'description': description,
                                              'departures': departures, 'tours': tours})


class TourView(TemplateView):
    def get(self, request, *args, **kwargs):
        return render(request, 'tour/tour.html', {'title': title, 'subtitle': subtitle, 'description': description,
                                                  'departures': departures, 'tours': tours})
